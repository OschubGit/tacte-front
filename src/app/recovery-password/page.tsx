...
export default function RecoveryPasswordPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const data = await api.recoveryPassword(formData.email);

            if (data.success) {
                // Login exitoso
                console.log("Recuperación de contraseña exitosa:", data.user);
                // Redirigir al dashboard o página principal
                router.push("/dashboard");
            } else {
                setError(
                    data.message || "Error en la recuperación de contraseña"
                );
            }
        } catch (error) {
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between">
                                        {/* <div className="flex gap-3">
                                            ...
                                            <label
                                                htmlFor="remember-me"
                                                className="block text-sm/6 text-tacte-primary-900"
                                            >
                                                Recuérdame
                                            </label>
                                        </div> */}
