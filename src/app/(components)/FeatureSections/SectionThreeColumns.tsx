            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <p className="mt-6 text-lg/8 text-gray-600">
                        Somos un centro de masajes y bienestar. Ofrecemos una
                        variedad de servicios relacionados con la salud en un
                        mismo lugar. Nuestro equipo está compuesto por
                        profesionales comprometidos con tu evolución y salud.
                    </p>
                </div>
