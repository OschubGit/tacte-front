...
const faqs = [
    {
        question:
            "¿Necesito estar en un momento de crisis para acudir a terapia?",
        answer: "No necesariamente. La terapia es un espacio para cuidarte, conocerte mejor y aprender herramientas que pueden ayudarte en cualquier etapa de tu vida.",
    },
    {
        question: "¿Con qué enfoques trabajas?",
        answer: "Trabajo principalmente con terapias de tercera generación, que integran aceptación, autocompasión y regulación emocional, siempre adaptándome a cada persona.",
    },
    {
        question: "¿Atiendes tanto online como presencial?",
        answer: "Sí, ofrezco ambas modalidades para que puedas elegir la que mejor se adapte a ti y a tus necesidades.",
    },
    {
        question: "¿Es confidencial lo que comparta en sesión?",
        answer: "Absolutamente. Todo lo que se comparte en consulta es tratado con total confidencialidad y respeto.",
    },
];
