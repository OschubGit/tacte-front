...
const faqs = [
    {
        ...
        answer: "No, puedes acudir directamente a consulta. Sin embargo, si ya cuentas con diagnóstico médico, lo integramos en tu tratamiento.",
    },
    {
        question: "¿Qué debo llevar a mi primera sesión?",
        answer: "Ropa cómoda que te permita moverte, cualquier informe médico que tengas y, sobre todo, ganas de empezar tu recuperación.",
    },
    {
        question: "¿Con qué frecuencia debería acudir?",
        answer: "Depende de tu situación. Tras la primera evaluación, te recomendaré la frecuencia adecuada según tu evolución.",
    },
    {
        question:
            "¿Ofreces también tratamientos de mantenimiento o prevención?",
        answer: "Sí, además de tratar lesiones y patologías, trabajamos en la prevención y en el cuidado continuo de tu bienestar físico.",
    },
];
    ...
    return (
        <>
            ...
            {/* <LandingAboutMeSticky
                ...
                imageAlt="Vera Domínguez, fisioterapeuta"
            /> */}
