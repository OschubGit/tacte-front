      ...
      <div className="bg-white pb-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
            Selecciona una fecha para ver las sesiones disponibles. Puedes
            reservar al momento y cancelar si lo necesitas más tarde.
          </p>
        </div>
      </div>
...
const CalendarFooter = ({ selected }: { selected: Date | undefined }) => {
  return (
    <div>
      ...
      <div className="pt-4 pb-1 text-left text-tacte-primary-600 text-xs">
        <p>Los dias marcados en verde indican los dias que tienes reservas.</p>
      </div>
    </div>
  );
};
