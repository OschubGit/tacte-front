...
const faqs = [
    {
        ...
        answer: "No. Mi enfoque es no restrictivo. Diseñamos juntos un plan nutricional flexible, realista y sostenible.",
    },
    {
        question: "¿Cuánto dura el proceso?",
        answer: "Depende de tus objetivos y necesidades. Algunas personas alcanzan cambios en pocas semanas, mientras que otras requieren un acompañamiento más prolongado.",
    },
    {
        question: "¿Puedo combinarlo con entrenamientos?",
        answer: "Claro. La nutrición es clave para mejorar tu rendimiento deportivo y optimizar la recuperación.",
    },
    {
        question: "¿Qué pasa si tengo una condición de salud?",
        answer: "Trabajo con dietoterapia adaptada a patologías como diabetes, hipertensión, colesterol elevado o SOP, siempre con base científica.",
    },
    {
        question: "¿Haces consultas online?",
        answer: "Sí, ofrezco tanto consultas presenciales como online para que puedas elegir la modalidad que mejor se adapte a ti.",
    },
];
