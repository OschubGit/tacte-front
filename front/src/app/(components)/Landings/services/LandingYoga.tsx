...
const faqs = [
    {
        ...
        answer: "No, las clases están diseñadas para adaptarse a cualquier nivel. Lo importante es traer apertura y ganas de explorar.",
    },
    {
        question: "¿Qué debo llevar a las sesiones?",
        answer: "Ropa cómoda que permita moverte con libertad, una esterilla de yoga y, si lo deseas, una botella de agua.",
    },
    {
        question: "¿Qué beneficios puedo esperar?",
        answer: "Mejorar la flexibilidad, liberar tensiones físicas y mentales, conectar con tus emociones y ganar claridad en tu día a día.",
    },
    {
        question: "¿Las clases son individuales o en grupo?",
        answer: "Ambas opciones están disponibles: sesiones personalizadas o grupos reducidos para compartir la experiencia.",
    },
];
