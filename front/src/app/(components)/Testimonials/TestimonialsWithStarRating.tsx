        ...
        <section className="bg-tacte-primary-50 px-6 py-24 sm:py-32 lg:px-8 relative isolate overflow-hidden">
            <figure className="mx-auto max-w-2xl">
                ...
                <blockquote className="mt-10 text-xl/8 font-semibold tracking-tight text-gray-900 sm:text-2xl/9">
                    <p>
                        “Llevo viniendo desde hace 5 años y recomiendo 100% sus
                        servicios. Me ha tratado varias lesiones, de las cuales
                        he salido recuperada y también voy una vez al mes para
                        revisiones periódicas y mantenimiento de mi dolor de
                        espalda y gracias a lo que estudia y se forma, hemos
                        podido conseguir una gran mejora. Es un gran profesional
                        y una gran persona.”
                    </p>
                </blockquote>
